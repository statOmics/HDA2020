...
```{r create_matrix}
## c() creates a vector
values <- c(3, 6, 1, 2, 0.23, 0.46, -2, -4)

## Define the matrix X, filling matrix "byrow": 4 x 2
X <- matrix(values, nrow = 4, byrow = TRUE)
X
...
# Creating a second matrix: 2 x 4, using the square of `values`
Y <- matrix(values^2, nrow = 2, ncol = 4)
Y
